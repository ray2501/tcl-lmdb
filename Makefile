...
PKG_SOURCES	=  tclmdb.c mdb.c midl.c
PKG_OBJECTS	=  tclmdb.o mdb.o midl.o
...
PKG_LIB_FILE	= liblmdb0.4.3.so
PKG_LIB_FILE8	= liblmdb0.4.3.so
PKG_LIB_FILE9	= libtcl9lmdb0.4.3.so
PKG_STUB_LIB_FILE = liblmdbstub0.4.3.a
